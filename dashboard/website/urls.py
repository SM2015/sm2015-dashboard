...
urlpatterns = patterns('',
    ...
    url(r'^user/login/external/?$', views.dashboard_login_external, name="dashboard_login_external"),
    ...
    url(r'^user/forgot-password/external?$', views.forgot_password_external, name="forgot_password_external"),
