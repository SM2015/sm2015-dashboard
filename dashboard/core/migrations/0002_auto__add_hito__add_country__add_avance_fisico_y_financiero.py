...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'core', ['hito'])
    ...
    models = {
        ...
        u'core.avance_fisico_y_financiero': {
            'Meta': {'object_name': 'avance_fisico_y_financiero'},
