...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column(u'core_dashboarduser_countries', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Country']))

    def backwards(self, orm):
        db.alter_column(u'core_dashboarduser_countries', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tables.Country']))
