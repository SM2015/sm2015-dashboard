...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm.Country.objects.create(id=1, name='Belize')
        orm.Country.objects.create(id=2, name='Costa Rica')
        orm.Country.objects.create(id=3, name='El Salvador')
        orm.Country.objects.create(id=4, name='Guatemala')
        orm.Country.objects.create(id=5, name='Honduras')
        orm.Country.objects.create(id=6, name='Mexico')
        orm.Country.objects.create(id=7, name='Nicaragua')
        orm.Country.objects.create(id=8, name='Panama')
