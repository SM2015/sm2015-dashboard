...
urlpatterns = patterns('',
    ...
    url(r'^ucmilestone-noneditable/?$', views.ucmilestone_noneditable, name="ucmilestone-noneditable"),
    url(r'^sm2015milestone/?$', views.sm2015milestone, name="sm2015milestone"),
    url(r'^sm2015milestone-noneditable/?$', views.sm2015milestone_noneditable, name="sm2015milestone-noneditable"),
    ...
    url(r'render/ucmilestone-noneditable/?$', views_render.render_ucmilestone_noneditable, name="table_render_ucmilestone-noneditable"),
    url(r'render/sm2015milestone/(?P<year>\d{4})?$', views_render.render_sm2015milestone, name="table_render_sm2015milestone"),
    url(r'render/sm2015milestone-noneditable/(?P<year>\d{4})?$', views_render.render_sm2015milestone_noneditable, name="table_render_sm2015milestone-noneditable"),
    ...
    url(r'chart_flot/(?P<uuid_origin>[\_A-Z]+)/?$', views.chart_flot, name="chart_flot"),
