...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sm2015Milestone.date'
        db.add_column(u'tables_sm2015milestone', 'date',
                      self.gf('django.db.models.fields.DateField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sm2015Milestone.date'
        db.delete_column(u'tables_sm2015milestone', 'date')
