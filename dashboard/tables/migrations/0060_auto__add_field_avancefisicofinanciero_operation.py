...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AvanceFisicoFinanciero.operation'
        db.add_column(u'tables_avancefisicofinanciero', 'operation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tables.Operation']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AvanceFisicoFinanciero.operation'
        db.delete_column(u'tables_avancefisicofinanciero', 'operation_id')
