...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LifeSaveField.name'
        db.alter_column(u'tables_lifesavefield', 'name', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'LifeSaveField.abbr'
        db.alter_column(u'tables_lifesavefield', 'abbr', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'LifeSaveField.name'
        db.alter_column(u'tables_lifesavefield', 'name', self.gf('django.db.models.fields.CharField')(default=None, max_length=500))

        # Changing field 'LifeSaveField.abbr'
        db.alter_column(u'tables_lifesavefield', 'abbr', self.gf('django.db.models.fields.CharField')(default=None, max_length=200))
