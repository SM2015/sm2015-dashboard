...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CountryRiskIdentification.type'
        db.add_column(u'tables_countryriskidentification', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tables.CountryRiskIdentificationTypes']),
                      keep_default=False)

        # Adding field 'CountryRiskIdentification.level'
        db.add_column(u'tables_countryriskidentification', 'level',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tables.CountryRiskIdentificationLevel']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CountryRiskIdentification.type'
        db.delete_column(u'tables_countryriskidentification', 'type_id')

        # Deleting field 'CountryRiskIdentification.level'
        db.delete_column(u'tables_countryriskidentification', 'level_id')
