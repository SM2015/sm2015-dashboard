...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm.HitoAudiencia.objects.create(name="Pais")
        orm.HitoAudiencia.objects.create(name="BID")
        orm.HitoAudiencia.objects.create(name="Donantes")

    def backwards(self, orm):
        orm.HitoAudiencia.objects.all().delete()
