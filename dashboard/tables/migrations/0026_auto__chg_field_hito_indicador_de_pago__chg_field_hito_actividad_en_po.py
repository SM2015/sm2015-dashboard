...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Hito.indicador_de_pago'
        db.alter_column(u'tables_hito', 'indicador_de_pago', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'Hito.actividad_en_poa'
        db.alter_column(u'tables_hito', 'actividad_en_poa', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'Hito.estado_actual'
        db.alter_column(u'tables_hito', 'estado_actual_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tables.EstadoActual'], null=True))

        # Changing field 'Hito.hito'
        db.alter_column(u'tables_hito', 'hito', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'Hito.indicador_de_pago'
        db.alter_column(u'tables_hito', 'indicador_de_pago', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Hito.actividad_en_poa'
        db.alter_column(u'tables_hito', 'actividad_en_poa', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
        ...
        # Changing field 'Hito.hito'
        db.alter_column(u'tables_hito', 'hito', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
