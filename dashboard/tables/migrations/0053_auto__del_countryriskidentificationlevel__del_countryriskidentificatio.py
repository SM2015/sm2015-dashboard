...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CountryRiskIdentificationFields'
        db.create_table(u'tables_countryriskidentificationfields', (
        ...
        db.send_create_signal(u'tables', ['CountryRiskIdentificationFields'])

        # Adding model 'CountryRiskLevels'
        db.create_table(u'tables_countryrisklevels', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True)),
        ))
        db.send_create_signal(u'tables', ['CountryRiskLevels'])

        # Adding model 'CountryRiskTypes'
        db.create_table(u'tables_countryrisktypes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True)),
        ))
        db.send_create_signal(u'tables', ['CountryRiskTypes'])
        ...
        # Adding field 'CountryRiskIdentification.field'
        db.add_column(u'tables_countryriskidentification', 'field',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tables.CountryRiskIdentificationFields']),
                      keep_default=False)

        # Adding field 'CountryRiskIdentification.value'
        db.add_column(u'tables_countryriskidentification', 'value',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


        # Changing field 'CountryRiskIdentification.type'
        db.alter_column(u'tables_countryriskidentification', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tables.CountryRiskTypes']))

        # Changing field 'CountryRiskIdentification.level'
        db.alter_column(u'tables_countryriskidentification', 'level_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tables.CountryRiskLevels']))
        # Adding field 'CountryMainRisks.date'
        db.add_column(u'tables_countrymainrisks', 'date',
                      self.gf('django.db.models.fields.DateField')(default=None, null=True),
                      keep_default=False)


        # Changing field 'CountryMainRisks.level'
        db.alter_column(u'tables_countrymainrisks', 'level_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tables.CountryRiskLevels']))

        # Changing field 'CountryMainRisks.type'
        db.alter_column(u'tables_countrymainrisks', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tables.CountryRiskTypes']))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CountryRiskIdentificationFields'
        db.delete_table(u'tables_countryriskidentificationfields')

        # Deleting model 'CountryRiskLevels'
        db.delete_table(u'tables_countryrisklevels')

        # Deleting model 'CountryRiskTypes'
        db.delete_table(u'tables_countryrisktypes')
        ...
        # Deleting field 'CountryRiskIdentification.field'
        db.delete_column(u'tables_countryriskidentification', 'field_id')

        # Deleting field 'CountryRiskIdentification.value'
        db.delete_column(u'tables_countryriskidentification', 'value')


        # Changing field 'CountryRiskIdentification.type'
        db.alter_column(u'tables_countryriskidentification', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tables.CountryRiskIdentificationTypes']))

        # Changing field 'CountryRiskIdentification.level'
        db.alter_column(u'tables_countryriskidentification', 'level_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tables.CountryRiskIdentificationLevel']))
        # Deleting field 'CountryMainRisks.date'
        db.delete_column(u'tables_countrymainrisks', 'date')


        # Changing field 'CountryMainRisks.level'
        db.alter_column(u'tables_countrymainrisks', 'level_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tables.CountryRiskIdentificationLevel']))

        # Changing field 'CountryMainRisks.type'
        db.alter_column(u'tables_countrymainrisks', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tables.CountryRiskIdentificationTypes']))
