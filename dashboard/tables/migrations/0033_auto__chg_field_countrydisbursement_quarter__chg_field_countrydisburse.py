...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CountryDisbursement.description'
        db.alter_column(u'tables_countrydisbursement', 'description', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

        # Changing field 'CountryDisbursement.year'
        db.alter_column(u'tables_countrydisbursement', 'year', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))

    def backwards(self, orm):

        # Changing field 'CountryDisbursement.quarter'
        db.alter_column(u'tables_countrydisbursement', 'quarter', self.gf('django.db.models.fields.CharField')(max_length=7))

        # Changing field 'CountryDisbursement.description'
        db.alter_column(u'tables_countrydisbursement', 'description', self.gf('django.db.models.fields.CharField')(max_length=300))

        # Changing field 'CountryDisbursement.year'
        db.alter_column(u'tables_countrydisbursement', 'year', self.gf('django.db.models.fields.CharField')(max_length=4))
    ...
    models = {
        ...
        u'tables.countrydisbursement': {
            ...
            'quarter': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '7', 'null': 'True'}),
