...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CountryDisbursementCharger'
        db.create_table(u'tables_countrydisbursementcharger', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'tables', ['CountryDisbursementCharger'])

        # Adding model 'CountryDisbursement'
        db.create_table(u'tables_countrydisbursement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Country'], null=True)),
            ('operation', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tables.Operation'], null=True)),
            ('charger', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tables.CountryDisbursementCharger'], null=True)),
            ('year', self.gf('django.db.models.fields.CharField')(default='', max_length=4)),
            ('quarter', self.gf('django.db.models.fields.CharField')(default='', max_length=7)),
        ...
        db.send_create_signal(u'tables', ['CountryDisbursement'])


    def backwards(self, orm):
        # Deleting model 'CountryDisbursementCharger'
        db.delete_table(u'tables_countrydisbursementcharger')

        # Deleting model 'CountryDisbursement'
        db.delete_table(u'tables_countrydisbursement')
    ...
    models = {
        ...
        u'tables.countrydisbursement': {
            ...
            'quarter': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '7'}),
