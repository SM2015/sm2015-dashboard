...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm_fields = orm.CountryRiskIdentificationFields
        orm_fields.objects.create(name='Quality', uuid="QUALITY")
        orm_fields.objects.create(name='Context', uuid="CONTEXT")
        orm_fields.objects.create(name='Strategic', uuid="STRATEGIC")
        orm_fields.objects.create(name='Financial', uuid="FINANCIAL")
        orm_fields.objects.create(name='Interested', uuid="INTERESTED")
        orm_fields.objects.create(name='Institutional Leadership', uuid="INSTITUTIONAL_LEADERSHIP")
        orm_fields.objects.create(name='Operational', uuid="OPERATIONAL")
        orm_fields.objects.create(name='Social and Environmental', uuid="SOCIAL_AND_ENVIRONMENTAL")
        orm_fields.objects.create(name='Sustainability', uuid="SUSTAINABILITY")

    def backwards(self, orm):
        for field in orm.CountryRiskIdentificationFields.all():
            field.delete()
