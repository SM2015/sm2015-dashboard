...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OperationTotalInvestment'
        db.create_table(u'tables_operationtotalinvestment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('operation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tables.Operation'])),
            ('investment_tranche_first_operation', self.gf('django.db.models.fields.FloatField')()),
            ('investment_tranche_second_operation', self.gf('django.db.models.fields.FloatField')()),
            ('counterpart_tranche_first_operation', self.gf('django.db.models.fields.FloatField')()),
            ('counterpart_tranche_second_operation', self.gf('django.db.models.fields.FloatField')()),
            ('cost_of_the_operation_first_operation', self.gf('django.db.models.fields.FloatField')()),
            ('cost_of_the_operation_second_operation', self.gf('django.db.models.fields.FloatField')()),
            ('performance_tranche_first_operation', self.gf('django.db.models.fields.FloatField')()),
            ('performance_tranche_second_operation', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'tables', ['OperationTotalInvestment'])


    def backwards(self, orm):
        # Deleting model 'OperationTotalInvestment'
        db.delete_table(u'tables_operationtotalinvestment')
