...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CountryMainRisks.language'
        db.add_column(u'tables_countrymainrisks', 'language',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.Language']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CountryMainRisks.language'
        db.delete_column(u'tables_countrymainrisks', 'language_id')
