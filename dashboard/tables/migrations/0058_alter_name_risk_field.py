...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        field = orm.CountryRiskIdentificationFields.objects.get(uuid='INTERESTED')
        field.uuid = 'STAKEHOLDERS'
        field.name = 'Stakeholders'
        field.save()

    def backwards(self, orm):
        field = orm.CountryRiskIdentificationFields.objects.get(uuid='STAKEHOLDERS')
        field.uuid = 'Interested'
