...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OperationInfos'
        db.create_table(u'tables_operationinfos', (
            ...
            ('objectives_progress', self.gf('django.db.models.fields.TextField')()),
            ('key_results_expected', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'tables', ['OperationInfos'])

        # Deleting field 'Operation.key_results_expected'
        db.delete_column(u'tables_operation', 'key_results_expected')

        # Deleting field 'Operation.objectives_progress'
        db.delete_column(u'tables_operation', 'objectives_progress')


    def backwards(self, orm):
        # Deleting model 'OperationInfos'
        db.delete_table(u'tables_operationinfos')

        # Adding field 'Operation.key_results_expected'
        db.add_column(u'tables_operation', 'key_results_expected',
                      self.gf('django.db.models.fields.TextField')(default=None),
                      keep_default=False)

        # Adding field 'Operation.objectives_progress'
        db.add_column(u'tables_operation', 'objectives_progress',
                      self.gf('django.db.models.fields.TextField')(default=None),
                      keep_default=False)
