...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OperationTotalInvestment.investment_tranche_third_operation'
        db.add_column(u'tables_operationtotalinvestment', 'investment_tranche_third_operation',
                      self.gf('django.db.models.fields.FloatField')(default=None),
                      keep_default=False)

        # Adding field 'OperationTotalInvestment.counterpart_tranche_third_operation'
        db.add_column(u'tables_operationtotalinvestment', 'counterpart_tranche_third_operation',
                      self.gf('django.db.models.fields.FloatField')(default=None),
                      keep_default=False)

        # Adding field 'OperationTotalInvestment.cost_of_the_operation_third_operation'
        db.add_column(u'tables_operationtotalinvestment', 'cost_of_the_operation_third_operation',
                      self.gf('django.db.models.fields.FloatField')(default=None),
                      keep_default=False)

        # Adding field 'OperationTotalInvestment.performance_tranche_third_operation'
        db.add_column(u'tables_operationtotalinvestment', 'performance_tranche_third_operation',
                      self.gf('django.db.models.fields.FloatField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OperationTotalInvestment.investment_tranche_third_operation'
        db.delete_column(u'tables_operationtotalinvestment', 'investment_tranche_third_operation')

        # Deleting field 'OperationTotalInvestment.counterpart_tranche_third_operation'
        db.delete_column(u'tables_operationtotalinvestment', 'counterpart_tranche_third_operation')

        # Deleting field 'OperationTotalInvestment.cost_of_the_operation_third_operation'
        db.delete_column(u'tables_operationtotalinvestment', 'cost_of_the_operation_third_operation')

        # Deleting field 'OperationTotalInvestment.performance_tranche_third_operation'
        db.delete_column(u'tables_operationtotalinvestment', 'performance_tranche_third_operation')
