...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CountryMainRisks.level'
        db.delete_column(u'tables_countrymainrisks', 'level_id')

        # Deleting field 'CountryMainRisks.response_strategy'
        db.delete_column(u'tables_countrymainrisks', 'response_strategy')

        # Adding field 'CountryMainRisks.current_status'
        db.add_column(u'tables_countrymainrisks', 'current_status',
                      self.gf('django.db.models.fields.TextField')(default=None),
                      keep_default=False)

        # Adding field 'CountryMainRisks.qualification'
        db.add_column(u'tables_countrymainrisks', 'qualification',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True),
                      keep_default=False)

        # Adding field 'CountryMainRisks.current_risk_rating'
        db.add_column(u'tables_countrymainrisks', 'current_risk_rating',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='current_risk_rating', null=True, to=orm['tables.CountryRiskLevels']),
                      keep_default=False)

        # Adding field 'CountryMainRisks.risk_rating_base'
        db.add_column(u'tables_countrymainrisks', 'risk_rating_base',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='risk_rating_base', null=True, to=orm['tables.CountryRiskLevels']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CountryMainRisks.level'
        db.add_column(u'tables_countrymainrisks', 'level',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tables.CountryRiskLevels']),
                      keep_default=False)

        # Adding field 'CountryMainRisks.response_strategy'
        db.add_column(u'tables_countrymainrisks', 'response_strategy',
                      self.gf('django.db.models.fields.TextField')(default=None),
                      keep_default=False)

        # Deleting field 'CountryMainRisks.current_status'
        db.delete_column(u'tables_countrymainrisks', 'current_status')

        # Deleting field 'CountryMainRisks.qualification'
        db.delete_column(u'tables_countrymainrisks', 'qualification')

        # Deleting field 'CountryMainRisks.current_risk_rating'
        db.delete_column(u'tables_countrymainrisks', 'current_risk_rating_id')

        # Deleting field 'CountryMainRisks.risk_rating_base'
        db.delete_column(u'tables_countrymainrisks', 'risk_rating_base_id')
