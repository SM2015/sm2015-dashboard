...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Operation.is_current'
        db.add_column(u'tables_operation', 'is_current',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Operation.is_current'
        db.delete_column(u'tables_operation', 'is_current')
