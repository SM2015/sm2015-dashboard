...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sm2015Milestone.objective'
        db.alter_column(u'tables_sm2015milestone', 'objective_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tables.Objective'], null=True))

    def backwards(self, orm):

        # Changing field 'Sm2015Milestone.objective'
        db.alter_column(u'tables_sm2015milestone', 'objective_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tables.Objective']))
