...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LifeSave'
        db.create_table(u'tables_lifesave', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Country'])),
            ('field', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tables.LifeSaveField'], null=True)),
            ('percentage', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('number_saving', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'tables', ['LifeSave'])

        # Adding model 'LifeSaveField'
        db.create_table(u'tables_lifesavefield', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('abbr', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'tables', ['LifeSaveField'])


    def backwards(self, orm):
        # Deleting model 'LifeSave'
        db.delete_table(u'tables_lifesave')

        # Deleting model 'LifeSaveField'
        db.delete_table(u'tables_lifesavefield')
