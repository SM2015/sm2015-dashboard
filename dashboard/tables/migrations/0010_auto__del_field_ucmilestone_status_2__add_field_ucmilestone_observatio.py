...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UcMilestone.status_2'
        db.delete_column(u'tables_ucmilestone', 'status_2')

        # Adding field 'UcMilestone.observation'
        db.add_column(u'tables_ucmilestone', 'observation',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UcMilestone.status_2'
        db.add_column(u'tables_ucmilestone', 'status_2',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UcMilestone.observation'
        db.delete_column(u'tables_ucmilestone', 'observation')
