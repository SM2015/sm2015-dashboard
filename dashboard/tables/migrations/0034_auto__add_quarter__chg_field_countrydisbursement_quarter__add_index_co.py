...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tables_quarter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=7)),
        ))
        db.send_create_signal(u'tables', ['Quarter'])


        # Renaming column for 'CountryDisbursement.quarter' to match new field type.
        db.rename_column(u'tables_countrydisbursement', 'quarter', 'quarter_id')
        # Changing field 'CountryDisbursement.quarter'
        db.alter_column(u'tables_countrydisbursement', 'quarter_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tables.Quarter']))
        # Adding index on 'CountryDisbursement', fields ['quarter']
        db.create_index(u'tables_countrydisbursement', ['quarter_id'])


        # Renaming column for 'UcMilestone.quarter' to match new field type.
        db.rename_column(u'tables_ucmilestone', 'quarter', 'quarter_id')
        # Changing field 'UcMilestone.quarter'
        db.alter_column(u'tables_ucmilestone', 'quarter_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tables.Quarter']))
        # Adding index on 'UcMilestone', fields ['quarter']
        db.create_index(u'tables_ucmilestone', ['quarter_id'])

        # Deleting field 'Hito.trimestre'
        db.delete_column(u'tables_hito', 'trimestre')

        # Adding field 'Hito.quarter'
        db.add_column(u'tables_hito', 'quarter',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tables.Quarter']),
                      keep_default=False)


    def backwards(self, orm):
        # Removing index on 'UcMilestone', fields ['quarter']
        db.delete_index(u'tables_ucmilestone', ['quarter_id'])

        # Removing index on 'CountryDisbursement', fields ['quarter']
        db.delete_index(u'tables_countrydisbursement', ['quarter_id'])

        # Deleting model 'Quarter'
        db.delete_table(u'tables_quarter')


        # Renaming column for 'CountryDisbursement.quarter' to match new field type.
        db.rename_column(u'tables_countrydisbursement', 'quarter_id', 'quarter')
        # Changing field 'CountryDisbursement.quarter'
        db.alter_column(u'tables_countrydisbursement', 'quarter', self.gf('django.db.models.fields.CharField')(max_length=7, null=True))

        # Renaming column for 'UcMilestone.quarter' to match new field type.
        db.rename_column(u'tables_ucmilestone', 'quarter_id', 'quarter')
        # Changing field 'UcMilestone.quarter'
        db.alter_column(u'tables_ucmilestone', 'quarter', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
        # Adding field 'Hito.trimestre'
        db.add_column(u'tables_hito', 'trimestre',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Hito.quarter'
        db.delete_column(u'tables_hito', 'quarter_id')
