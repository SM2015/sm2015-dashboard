...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CountryOperationIT'
        db.create_table(u'tables_countryoperationit', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Country'], null=True)),
            ('it', self.gf('django.db.models.fields.FloatField')(default=0)),
        ))
        db.send_create_signal(u'tables', ['CountryOperationIT'])

        # Adding model 'CountryOperation'
        db.create_table(u'tables_countryoperation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Country'], null=True)),
            ('quarter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tables.Quarter'])),
            ('it_disbursements_planned', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('it_disbursements_actual', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('it_execution_planned', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('it_execution_actual', self.gf('django.db.models.fields.FloatField')(default=0)),
        ))
        db.send_create_signal(u'tables', ['CountryOperation'])


    def backwards(self, orm):
        # Deleting model 'CountryOperationIT'
        db.delete_table(u'tables_countryoperationit')

        # Deleting model 'CountryOperation'
        db.delete_table(u'tables_countryoperation')
