...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm.CountryRiskLevels.objects.create(name='Very High', uuid="VERY_HIGH")
        orm.CountryRiskLevels.objects.create(name='High', uuid="HIGH")
        orm.CountryRiskLevels.objects.create(name='Medium', uuid="MEDIUM")
        orm.CountryRiskLevels.objects.create(name='Low', uuid="LOW")

        orm.CountryRiskTypes.objects.create(name='Positive', uuid="POSITIVE")
        orm.CountryRiskTypes.objects.create(name='Negative', uuid="NEGATIVE")

    def backwards(self, orm):
        for obj in orm.CountryRiskTypes.objects.all():
            obj.delete()

        for obj in orm.CountryRiskLevels.objects.all():
            obj.delete()
