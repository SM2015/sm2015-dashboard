...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AvanceFisicoFinanciero.upcoming_policy_dialogue_events'
        db.add_column(u'tables_avancefisicofinanciero', 'upcoming_policy_dialogue_events',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AvanceFisicoFinanciero.upcoming_policy_dialogue_events'
        db.delete_column(u'tables_avancefisicofinanciero', 'upcoming_policy_dialogue_events')
