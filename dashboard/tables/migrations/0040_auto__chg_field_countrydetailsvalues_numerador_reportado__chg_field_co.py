...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CountryDetailsValues.numerador_reportado'
        db.alter_column(u'tables_countrydetailsvalues', 'numerador_reportado', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'CountryDetailsValues.denominador_reportado'
        db.alter_column(u'tables_countrydetailsvalues', 'denominador_reportado', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'CountryDetailsValues.numerador_reportado'
        db.alter_column(u'tables_countrydetailsvalues', 'numerador_reportado', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'CountryDetailsValues.denominador_reportado'
        db.alter_column(u'tables_countrydetailsvalues', 'denominador_reportado', self.gf('django.db.models.fields.FloatField')())
