...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm.GrantsFinancesType.objects.create(name='Real', uuid='GRANTS_TYPE_REAL')
        orm.GrantsFinancesType.objects.create(name='Expected', uuid='GRANTS_TYPE_EXPECTED')

    def backwards(self, orm):
        orm.GrantsFinancesType.objects.all().delete()
