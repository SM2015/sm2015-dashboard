...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CountryRiskIdentification.operation'
        db.add_column(u'tables_countryriskidentification', 'operation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tables.Operation']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CountryRiskIdentification.operation'
        db.delete_column(u'tables_countryriskidentification', 'operation_id')
