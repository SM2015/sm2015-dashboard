...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Sm2015Milestone'
        db.create_table(u'tables_sm2015milestone', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tables.Objective'])),
            ('hitos', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True)),
            ('observation', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'tables', ['Sm2015Milestone'])

        # Adding model 'Objective'
        db.create_table(u'tables_objective', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('objective', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'tables', ['Objective'])


    def backwards(self, orm):
        # Deleting model 'Sm2015Milestone'
        db.delete_table(u'tables_sm2015milestone')

        # Deleting model 'Objective'
        db.delete_table(u'tables_objective')
    ...
    models = {
        ...
        u'tables.sm2015milestone': {
            ...
            'country': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tables.Objective']"}),
