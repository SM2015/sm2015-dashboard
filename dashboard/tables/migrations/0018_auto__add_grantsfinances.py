...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GrantsFinances'
        db.create_table(u'tables_grantsfinances', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('period', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True)),
            ('contribution_accumulated_bmgf', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('contribution_accumulated_icss', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('contribution_spanish_government', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('korean_tc_accumulated', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('contribution_donates', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('contribution_real_bmgf', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('contribution_real_icss', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('contribution_real_gos', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
            ('korea_actual', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal(u'tables', ['GrantsFinances'])


    def backwards(self, orm):
        # Deleting model 'GrantsFinances'
        db.delete_table(u'tables_grantsfinances')
    ...
    models = {
        ...
        u'tables.grantsfinances': {
            ...
            'contribution_accumulated_bmgf': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'contribution_accumulated_icss': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'contribution_donates': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'contribution_real_bmgf': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'contribution_real_gos': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'contribution_real_icss': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'contribution_spanish_government': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'korea_actual': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'korean_tc_accumulated': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
