...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm.GrantsFinancesOrigin.objects.create(name='BMFG', uuid='GRANTS_ORIGIN_BMFG')
        orm.GrantsFinancesOrigin.objects.create(name='ICSS', uuid='GRANTS_ORIGIN_ICSS')
        orm.GrantsFinancesOrigin.objects.create(name='GoS', uuid='GRANTS_ORIGIN_GOS')
        orm.GrantsFinancesOrigin.objects.create(name='Korean T.C', uuid='GRANTS_ORIGIN_KOREAN')

    def backwards(self, orm):
        orm.GrantsFinancesOrigin.objects.all().delete()
