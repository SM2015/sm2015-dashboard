...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # , , SANTA LUCÍA, CONCEPCIÓN, CABAÑAS, SAN JERÓNIMO, COPÁN RUINAS, SANTA RITA, 
        # SANTIAGO DE PURINGLA, DULCE NAME DE CULMÍ, SAN JUAN GUARITA, COLOLACA, VALLADOLID, GUARITA, TAMBLA, TOMALÁ, CONCEPCIÓN DE MARIA, DUYURE, SAN MARCOS DE COLÓN.
        operation_honduras = orm.Operation.objects.get(country__slug='honduras')
        orm.OperationZones.objects.create(operation=operation_honduras, name='San Antonio', slug='san-antonio', latlng='')
        orm.OperationZones.objects.create(operation=operation_honduras, name='Magdalena', slug='magdalena', latlng='')

    def backwards(self, orm):
        orm.OperationZones.objects.all().delete()
