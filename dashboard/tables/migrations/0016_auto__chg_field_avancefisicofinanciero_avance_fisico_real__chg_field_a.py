...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AvanceFisicoFinanciero.avance_fisico_real'
        db.alter_column(u'tables_avancefisicofinanciero', 'avance_fisico_real', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'AvanceFisicoFinanciero.avance_fisico_planificado'
        db.alter_column(u'tables_avancefisicofinanciero', 'avance_fisico_planificado', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'AvanceFisicoFinanciero.avances_fisicos_original_programado'
        db.alter_column(u'tables_avancefisicofinanciero', 'avances_fisicos_original_programado', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'AvanceFisicoFinanciero.avance_financiero_actual'
        db.alter_column(u'tables_avancefisicofinanciero', 'avance_financiero_actual', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'AvanceFisicoFinanciero.avances_financieros_original_programado'
        db.alter_column(u'tables_avancefisicofinanciero', 'avances_financieros_original_programado', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'AvanceFisicoFinanciero.monto_desembolsado'
        db.alter_column(u'tables_avancefisicofinanciero', 'monto_desembolsado', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'AvanceFisicoFinanciero.monto_comprometido'
        db.alter_column(u'tables_avancefisicofinanciero', 'monto_comprometido', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'AvanceFisicoFinanciero.avance_financiero_planificado'
        db.alter_column(u'tables_avancefisicofinanciero', 'avance_financiero_planificado', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'AvanceFisicoFinanciero.avance_fisico_real'
        db.alter_column(u'tables_avancefisicofinanciero', 'avance_fisico_real', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'AvanceFisicoFinanciero.avance_fisico_planificado'
        db.alter_column(u'tables_avancefisicofinanciero', 'avance_fisico_planificado', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'AvanceFisicoFinanciero.avances_fisicos_original_programado'
        db.alter_column(u'tables_avancefisicofinanciero', 'avances_fisicos_original_programado', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'AvanceFisicoFinanciero.avance_financiero_actual'
        db.alter_column(u'tables_avancefisicofinanciero', 'avance_financiero_actual', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'AvanceFisicoFinanciero.avances_financieros_original_programado'
        db.alter_column(u'tables_avancefisicofinanciero', 'avances_financieros_original_programado', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'AvanceFisicoFinanciero.monto_desembolsado'
        db.alter_column(u'tables_avancefisicofinanciero', 'monto_desembolsado', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'AvanceFisicoFinanciero.monto_comprometido'
        db.alter_column(u'tables_avancefisicofinanciero', 'monto_comprometido', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'AvanceFisicoFinanciero.avance_financiero_planificado'
        db.alter_column(u'tables_avancefisicofinanciero', 'avance_financiero_planificado', self.gf('django.db.models.fields.IntegerField')(null=True))
