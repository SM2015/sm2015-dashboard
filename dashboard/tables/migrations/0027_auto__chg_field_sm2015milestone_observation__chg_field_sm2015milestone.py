...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sm2015Milestone.observation'
        db.alter_column(u'tables_sm2015milestone', 'observation', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'Sm2015Milestone.hitos'
        db.alter_column(u'tables_sm2015milestone', 'hitos', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'Sm2015Milestone.observation'
        db.alter_column(u'tables_sm2015milestone', 'observation', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Sm2015Milestone.hitos'
        db.alter_column(u'tables_sm2015milestone', 'hitos', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
