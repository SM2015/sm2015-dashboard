...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CountryDetailsPago'
        db.create_table(u'tables_countrydetailspago', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=500, null=True)),
            ('numero', self.gf('django.db.models.fields.IntegerField')(default=None, null=True)),
        ))
        db.send_create_signal(u'tables', ['CountryDetailsPago'])

        # Adding model 'CountryDetails'
        db.create_table(u'tables_countrydetails', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Country'], null=True)),
            ('pago', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tables.CountryDetailsPago'], null=True)),
            ('isech', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tables.CountryDetailsIsech'], null=True)),
            ('level', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tables.CountryDetailsLevel'], null=True)),
            ('location', self.gf('django.db.models.fields.CharField')(default='', max_length=300, null=True)),
        ))
        db.send_create_signal(u'tables', ['CountryDetails'])

        # Adding model 'CountryDetailsLevel'
        db.create_table(u'tables_countrydetailslevel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=500, null=True)),
        ))
        db.send_create_signal(u'tables', ['CountryDetailsLevel'])

        # Adding model 'CountryDetailsIsech'
        db.create_table(u'tables_countrydetailsisech', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=500, null=True)),
            ('numero', self.gf('django.db.models.fields.FloatField')(default=None, null=True)),
        ))
        db.send_create_signal(u'tables', ['CountryDetailsIsech'])

        # Adding model 'CountryDetailsValues'
        db.create_table(u'tables_countrydetailsvalues', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('country_detail', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tables.CountryDetails'])),
            ('numerador_reportado', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('denominador_reportado', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('quarter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tables.Quarter'])),
        ))
        db.send_create_signal(u'tables', ['CountryDetailsValues'])


    def backwards(self, orm):
        # Deleting model 'CountryDetailsPago'
        db.delete_table(u'tables_countrydetailspago')

        # Deleting model 'CountryDetails'
        db.delete_table(u'tables_countrydetails')

        # Deleting model 'CountryDetailsLevel'
        db.delete_table(u'tables_countrydetailslevel')

        # Deleting model 'CountryDetailsIsech'
        db.delete_table(u'tables_countrydetailsisech')

        # Deleting model 'CountryDetailsValues'
        db.delete_table(u'tables_countrydetailsvalues')
    ...
    models = {
        ...
        u'tables.countrydetailsvalues': {
            ...
            'denominador_reportado': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'numerador_reportado': ('django.db.models.fields.FloatField', [], {'default': '0'}),
