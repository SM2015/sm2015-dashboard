...
def render_export_hitos_and_avances_refactory(request, country_slug):
    ...
    if avances:
        avance = avances[0]
        # Table Avances
        body.append(heading(u"AVANCE FISICO Y FINANCIERO", 2))
        ...
        tbl_rows = [[u'Cual es la fecha en que la información que está registrando fue actualizada', avance.avance_fisico_planificado],
                    [u'Avances Fiscos Planificados (Meta Ejecución)', avance.avance_fisico_planificado],
                    [u'Avances Físicos reales (Avance en la ejecución real segun el PEP)', avance.avance_fisico_real],
                    [u'Avances financieros planificados (Ejecución financiera planificados)', avance.avance_financiero_planificado],
                    [u'Avances financieros actuales (Ejecución financiera real según el estados financieros del ejecutor hasta la fecha (%))', avance.avance_financiero_actual],
                    [u'Monto total desembolsado (BID a PAIS)', avance.monto_desembolsado],
                   ]
